...
MS2_PUBLIC mblk_t* ms_buf_copy_from_ms_frame(YuvBuf *buf, int w, int h);
MS2_PUBLIC mblk_t* ms_buf_copy_from_buf(uint8_t *ptr, int size, int w, int h);
...
#define MS_FILTER_SET_CAM_PARAM     MS_FILTER_BASE_METHOD(106,const char*)   //TODO : check 106
#define MS_FILTER_GET_SOURCE_FMT    MS_FILTER_BASE_METHOD(107, int)

#define MS_SOURCE_FMT_DEFAULT     0
#define MS_SOURCE_FMT_ENCODED     1
