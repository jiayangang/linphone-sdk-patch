...
elseif(CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
	...
	if(WIN32)
		...
		elseif(ANDROID)
            ...
            if(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
				set(TOOLCHAIN_PREFIX "${TOOLCHAIN_PATH}/aarch64-linux-android-")
            else()
                set(TOOLCHAIN_PREFIX "${TOOLCHAIN_PATH}/arm-linux-androideabi-")
            endif()
			...
			if(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
				set(FFMPEG_ARCH "arm64")
				lcb_configure_options("--disable-asm")
			elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv7-a")
				lcb_configure_options("--disable-neon" "--cpu=cortex-a8" "--disable-armv5te" "--enable-armv6" "--enable-armv6t2")
			else()
