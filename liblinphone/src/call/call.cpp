...
void *Call::getNativePreviewWindowId () const {
	L_D();
	return static_pointer_cast<const MediaSession>(d->getActiveSession())->getNativePreviewVideoWindowId();
}
...
void Call::setNativePreviewWindowId (void *id) {
	L_D();
	static_pointer_cast<MediaSession>(d->getActiveSession())->setNativePreviewWindowId(id);
}
