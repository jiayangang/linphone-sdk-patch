...
void * linphone_call_get_native_preview_window_id(const LinphoneCall *call)
{
	return L_GET_CPP_PTR_FROM_C_OBJECT(call)->getNativePreviewWindowId();
}
void linphone_call_set_native_preview_window_id(LinphoneCall *call, void *id){
	L_GET_CPP_PTR_FROM_C_OBJECT(call)->setNativePreviewWindowId(id);
